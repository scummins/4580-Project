...
{
    /// <summary>
    /// The first part of the minority report right gesture
    /// </summary>
    public class MRStepRightSegment1 : IRelativeGestureSegment
    {
        /// <summary>
        /// Checks the gesture.
        /// </summary>
        ...
        public GesturePartResult CheckGesture(Skeleton skeleton)
        {
            ...
            // right and left hand between shoulders
            ...
            {
                // right and left hand between hip and shoulders in Y
                ...
                {
                    // right hand behind left hand and =  y
    ...
    /// <summary>
    /// The second part of the minority report right gesture
    /// </summary>
    public class MRStepRightSegment2 : IRelativeGestureSegment
    {
        /// <summary>
        /// Checks the gesture.
        /// </summary>
        ...
        public GesturePartResult CheckGesture(Skeleton skeleton)
        {
                ...
                skeleton.Joints[JointType.HandLeft].Position.X > skeleton.Joints[JointType.ShoulderLeft].Position.X && skeleton.Joints[JointType.HandLeft].Position.X < skeleton.Joints[JointType.ShoulderRight].Position.X)
            {
                ...
                if (skeleton.Joints[JointType.HandRight].Position.Y < skeleton.Joints[JointType.ShoulderCenter].Position.Y && skeleton.Joints[JointType.HandRight].Position.Y > skeleton.Joints[JointType.HipCenter].Position.Y &&
                    skeleton.Joints[JointType.HandLeft].Position.Y < skeleton.Joints[JointType.ShoulderCenter].Position.Y && skeleton.Joints[JointType.HandLeft].Position.Y > skeleton.Joints[JointType.HipCenter].Position.Y)
                {
                    // right hand above left hand and = Z
                    if (skeleton.Joints[JointType.HandRight].Position.Z == skeleton.Joints[JointType.HandLeft].Position.Z)
                    {
                        return GesturePartResult.Succeed;
                    }
    ...
    /// <summary>
    /// The third part of the minority report right gesture
    /// </summary>
    public class MRStepRightSegment3 : IRelativeGestureSegment
    {
        /// <summary>
        /// Checks the gesture.
        /// </summary>
        ...
        public GesturePartResult CheckGesture(Skeleton skeleton)
        {
                ...
                skeleton.Joints[JointType.HandLeft].Position.X > skeleton.Joints[JointType.ShoulderLeft].Position.X && skeleton.Joints[JointType.HandLeft].Position.X < skeleton.Joints[JointType.ShoulderRight].Position.X)
            {
                ...
                if (skeleton.Joints[JointType.HandRight].Position.Y < skeleton.Joints[JointType.ShoulderCenter].Position.Y && skeleton.Joints[JointType.HandRight].Position.Y > skeleton.Joints[JointType.HipCenter].Position.Y &&
                    skeleton.Joints[JointType.HandLeft].Position.Y < skeleton.Joints[JointType.ShoulderCenter].Position.Y && skeleton.Joints[JointType.HandLeft].Position.Y > skeleton.Joints[JointType.HipCenter].Position.Y)
                {
                    // //right hand in front of left hand and = y
                    if (skeleton.Joints[JointType.HandRight].Position.Z < skeleton.Joints[JointType.HandLeft].Position.Z)
                    {
                        return GesturePartResult.Succeed;
                    }
